...
interface IdleTimerResult {
  isWarning: boolean      // true cuando faltan menos de WARN_BEFORE_MS
  secondsRemaining: number // Segundos hasta el logout
  resetTimer: () => void  // Permite resetear desde fuera (ej: botón "Seguir usando")
}

export function useIdleTimer(timeoutMs: number, onIdle: () => void): IdleTimerResult {
